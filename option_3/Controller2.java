...
public class Controller2 implements Controller {
    ...
    public Controller2() {
        ...
        gridPane.add(tfScreen, 1, 2);
        gridPane.add(btSelectMovie, 2, 2);
        gridPane.add(lblConfirm, 0, 4);
      ...
      public void movieSelection() {
          ...
          try {
            if (title != null && time != null) {
              ...
              controller3.lblInfo.setText(title + " selected for the " + time +
                                         " showing in theatre " + screen);

              controller3.lblTitle.setText(title);
              controller3.lblCert.setText(certificate);
              controller3.lblTime.setText(time);
              controller3.lblScreen.setText(screen);
