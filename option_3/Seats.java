...
public class Seats extends Application implements EventHandler<ActionEvent> {
  ...
  public void handle(ActionEvent event){
    ...
    if(event.getSource()==button2 & condition==true){//IF Any SEAT IS SELECTED
      System.out.println("Seat A2 Has been selected");
      condition=false;
    }else if(event.getSource()==button2 & condition==false){//IF Any SEAT IS SELECTED
      System.out.println("Seat A2 Has been Deselected");
      condition=true;
    }
    if(event.getSource()==button3 & condition==true) {//IF Any SEAT IS SELECTED
      System.out.println("Seat A3 Has been selected");
      condition=false;
    }else if(event.getSource()==button3 & condition==false){
      System.out.println("Seat A3 Has been Deselected");
      condition=true;
    }
    ...
    if(event.getSource()==button6 & condition==true){//IF Any SEAT IS SELECTED
